...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, cs_lora_pb0_Pin|reset_lora_pb1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : cs_lora_pb0_Pin */
  GPIO_InitStruct.Pin = cs_lora_pb0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(cs_lora_pb0_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : reset_lora_pb1_Pin */
  GPIO_InitStruct.Pin = reset_lora_pb1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(reset_lora_pb1_GPIO_Port, &GPIO_InitStruct);
